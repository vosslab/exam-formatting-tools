...
#============================================
def test_split_question_code_removes_leading_code_paragraph() -> None:
...
#============================================
def test_split_question_code_without_code_returns_html_unchanged() -> None:
...
#============================================
def test_clean_inline_html_h6_becomes_bold_line_and_entities_stay_escaped() -> None:
...
#============================================
def test_pull_tables_takes_tables_without_cell_styles_too() -> None:
...
#============================================
def test_pull_tables_keeps_nested_tables_inside_their_parent() -> None:
...
#============================================
def test_pull_tables_keeps_single_row_sequence_strip_as_drawing() -> None:
	...
	assert len(tables) == 1
	assert ef_tools.bbq_html.clean_inline_html(remaining) == 'Site: end'


#============================================
def test_clean_inline_html_headings_and_hr() -> None:
	cleaned = ef_tools.bbq_html.clean_inline_html('<h4>Hint</h4><p>a</p><hr/><p>b</p>')
	assert cleaned == '<b>Hint</b>\na\nb'


#============================================
def test_write_table_pngs_writes_files_and_returns_yaml_relative_paths(tmp_path: object) -> None:
