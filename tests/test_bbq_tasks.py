...
#============================================
def test_load_tasks_expands_list_alias_and_skips_separator(task_repo):
...
#============================================
def test_load_tasks_resolves_input_and_flags(task_repo):
	repo_dir, csv_path = task_repo
	tasks = ef_tools.bbq_tasks.load_tasks(csv_path, _settings(repo_dir))
	ymcs = tasks[3]
...
#============================================
def test_load_tasks_missing_script_names_csv_line(task_repo):
	repo_dir, csv_path = task_repo
...
#============================================
def test_build_pythonpath_uses_repo_root_above_problems(task_repo, monkeypatch):
...
#============================================
def test_generate_question_retries_past_skipped_type():
	lines = iter(["NUM\t<p>How many?</p>\t4\t0", "MC\t<p>Pick</p>\ta\tCorrect\tb\tIncorrect"])

	def fake_candidate(task, pythonpath):
		return next(lines)
...
#============================================
def test_generate_question_retries_past_unprintable_candidate():
...
#============================================
def test_generate_question_gives_up_with_labelled_reason():
	def fake_candidate(task, pythonpath):
