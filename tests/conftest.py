...
_QTI_PACKAGE_MAKER_DIR = os.path.expanduser("~/nsh/PROBLEMS/qti-package-maker")
if os.path.isdir(_QTI_PACKAGE_MAKER_DIR) and _QTI_PACKAGE_MAKER_DIR not in sys.path:
	sys.path.insert(1, _QTI_PACKAGE_MAKER_DIR)
